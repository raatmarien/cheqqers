...
def main():
    ...
    parser.add_argument('--p2', help='Select agent for player 2 to use.', default=random_bot())
    ...
    if(args.num_columns % 2 == 1 and args.num_rows % 2 == 0):
        ...
        print("#"*warning_len)
        time.sleep(5)
    game = GameInterface(Checkers(num_vertical=args.num_rows, num_horizontal=args.num_columns, num_vertical_pieces=args.num_vertical_pieces), white_player=args.p1, black_player=args.p2 ,GUI=args.GUI)
    game.play()
